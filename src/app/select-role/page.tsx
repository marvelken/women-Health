...
import { selectRole } from "../login-signup/action"  // Update this path to match your actual actions file location
    ...
    <>
      <div className="p-8">
        ...
        <form className="space-y-4">
          {/* Changed to input type hidden + button to ensure form data is sent correctly */}
